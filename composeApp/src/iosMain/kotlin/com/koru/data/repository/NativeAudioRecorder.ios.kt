...
internal actual class NativeAudioRecorder {
    // var necessary: AVAudioEngine setup requires post-initialization configuration
    // and cannot be frozen as val after instantiation
    private var audioEngine: AVAudioEngine? = null

    // var necessary: SFSpeechAudioBufferRecognitionRequest requires manual cleanup
    // and state resets that cannot be managed with an immutable val
